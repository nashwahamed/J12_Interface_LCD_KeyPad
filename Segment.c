...
void Segment_Init(void){
	...
	//DIO_WritPin(SEGMANT_ENABLE_PORT,SEGMANT_EN1,DIO_PIN_HIGH);
	DIO_WritPin(SEGMANT_ENABLE_PORT,SEGMANT_EN2,DIO_PIN_HIGH);
...
void Segment_Display(uint8 val){
	...
	DIO_WritPort(DIO_PORTA, (DIO_PORTA | (val <<4)));
}
